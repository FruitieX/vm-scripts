#QEMU_PA_SAMPLES=512 QEMU_AUDIO_DRV=pa /home/rasse/src/qemu/x86_64-softmmu/qemu-system-x86_64 -monitor stdio -enable-kvm -M q35 -m 6000 -mem-path /dev/hugepages -cpu host \
QEMU_AUDIO_DRV=sdl /home/rasse/src/qemu/x86_64-softmmu/qemu-system-x86_64 -monitor stdio -enable-kvm -M q35 -m 6000 -mem-path /dev/hugepages -cpu host \
...
#-drive file=/dev/sdb7,id=disk,format=raw -device ide-hd,bus=ahci.0,drive=disk \
